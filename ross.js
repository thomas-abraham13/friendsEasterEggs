...
(async () => {
	...
	// Navigate to Ross Geller on Google
	await page.goto(`https://www.google.com/search?q=ross+geller`, { waitUntil: 'networkidle0' });

    // Click Accept on the Google Popup (Before you continue....)
    let accept = `#L2AGLb > div`;
    await page.click(accept);

    // Click the sofa icon to initiate the easter egg
